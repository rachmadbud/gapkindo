...
<style>
    ...
    .gpk-hero__slide.is-active .gpk-hero__eyebrow {
        animation: gpkRise 1s var(--ease-out) 0.4s forwards;
    }

    .gpk-hero__eyebrow::before {
        content: "";
        width: 32px;
        height: 1px;
    ...
    .gpk-hero__slide.is-active .gpk-hero__title {
        animation: gpkRise 1.2s var(--ease-out) 0.55s forwards;
    }
    ...
    .gpk-hero__slide.is-active .gpk-hero__lead {
        animation: gpkRise 1.2s var(--ease-out) 0.7s forwards;
    }
...
<div class="gpk-premium">
    ...
    <section class="gpk-hero" id="gpkHero">
        <div class="gpk-hero__track">
            ...
            @php
                $heroSlides = [
                    ['img' => '1.jpg',  'eyebrow' => 'Natural Rubber',     'title' => 'Memajukan industri <em>karet alam Indonesia</em>', 'lead' => 'GAPKINDO berdiri sebagai wadah perusahaan karet alam nasional untuk mengembangkan dan meningkatkan usaha perkaretan Indonesia di kancah dunia.'],
                    ['img' => '2.jpg',  'eyebrow' => 'Heritage',           'title' => 'Warisan perkebunan yang <em>berkelanjutan</em>',   'lead' => 'Dari hulu ke hilir, kami mengawal mutu dan standar produksi karet Indonesia agar terus relevan di pasar global.'],
                    ['img' => '3.jpg',  'eyebrow' => 'Processing',         'title' => 'Proses pengolahan <em>berstandar dunia</em>',      'lead' => 'Setiap tahap produksi mengikuti standar mutu internasional, dari pengolahan hingga pengiriman ke pelabuhan tujuan.'],
                    ['img' => '4.jpg',  'eyebrow' => 'Global Market',      'title' => 'Komoditas <em>ekspor utama</em> Indonesia',         'lead' => 'Karet alam Indonesia menjangkau lebih dari 50 negara, menjadi salah satu pendorong devisa nasional.'],
                    ['img' => '5.jpg',  'eyebrow' => 'Community',          'title' => 'Bersama membangun <em>ekosistem</em>',              'lead' => 'GAPKINDO menyatukan pelaku usaha, pemerintah, dan petani dalam ekosistem perkaretan yang sehat dan berkelanjutan.'],
                    ['img' => '6.jpg',  'eyebrow' => 'Sustainability',     'title' => 'Karet alam yang <em>ramah lingkungan</em>',         'lead' => 'Industri yang menyerap karbon, menjaga keanekaragaman hayati, dan menyejahterakan masyarakat sekitar perkebunan.'],
                ];
            @endphp
                    ...
                    <div class="gpk-hero__content">
                        <div class="gpk-container">
                            <div class="gpk-hero__inner">
                                <span class="gpk-hero__eyebrow">{{ $s['eyebrow'] }}</span>
