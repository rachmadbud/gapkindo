...
<style>
    ...
    .gpk-anggota-page, .gpk-anggota-page *, .gpk-anggota-page *::before, .gpk-anggota-page *::after {
        box-sizing: border-box;
    }
    .gpk-anggota-page a { color: inherit; text-decoration: none; }

    .gpk-anggota-page .gpk-container {
        max-width: 1320px;
        margin: 0 auto;
        padding: 0 20px;
    }
    ...
    .gpk-anggota-page .ang-stat--teal   { background: var(--grad-teal); }
    .gpk-anggota-page .ang-stat--purple { background: var(--grad-purple); }
    .gpk-anggota-page .ang-stat--amber  { background: var(--grad-amber); }
    ...
    .gpk-anggota-page .ang-stat__icon svg { width: 100%; height: 100%; }

    @media (max-width: 720px) {
        .gpk-anggota-page .ang-stats__grid { grid-template-columns: 1fr; }
    }
    ...
    .gpk-anggota-page .ang-tabs::-webkit-scrollbar { height: 6px; }
    .gpk-anggota-page .ang-tabs::-webkit-scrollbar-track { background: transparent; }
    .gpk-anggota-page .ang-tabs::-webkit-scrollbar-thumb { background: var(--c-line); border-radius: 3px; }
    ...
    /* TABLES */
    .gpk-anggota-page .ang-tab-content { display: none; }
    .gpk-anggota-page .ang-tab-content.is-active { display: block; }
    ...
    @media (max-width: 768px) {
        ...
        .gpk-anggota-page .ang-search { max-width: 100%; }
        .gpk-anggota-page .ang-toolbar__info { margin-left: 0; width: 100%; }

        .gpk-anggota-page .ang-table-wrap {
            background: var(--c-bg-softer);
            padding: 0.75rem;
        }
        .gpk-anggota-page .ang-table thead { display: none; }
        .gpk-anggota-page .ang-table,
        ...
        .gpk-anggota-page .ang-table tbody tr:hover { background: #fff; }
        .gpk-anggota-page .ang-table td {
            display: flex;
        ...
        .gpk-anggota-page .ang-table td:last-child { border-bottom: none; }
        ...
        .gpk-anggota-page .ang-empty::before { display: none; }
    }

    @media (max-width: 480px) {
        .gpk-anggota-page .ang-hero { padding: 2.5rem 0 4.5rem; }
        .gpk-anggota-page .ang-stat { padding: 1.25rem; }
        .gpk-anggota-page .ang-stat__num { font-size: 2rem; }
    }
</style>
@endpush
            ...
            <div class="ang-panel">
                    ...
                    <div class="ang-tabs__inner">
                        ...
                        <button class="ang-tab is-active" data-target="tab1" type="button">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                <path d="M12 2L8 6h3v4H7v-2l-4 4 4 4v-2h4v4H8l4 4 4-4h-3v-4h4v2l4-4-4-4v2h-4V6h3l-4-4z"/>
                            </svg>
                ...
                <div class="ang-toolbar">
                    <div class="ang-search">
                        <svg class="ang-search__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="11" cy="11" r="8"/>
                            <line x1="21" y1="21" x2="16.65" y2="16.65"/>
                        </svg>
                        <input type="text" class="ang-search__input" id="angSearch" placeholder="Cari perusahaan, cabang, atau email...">
                    </div>
                        ...
                        <div class="ang-table-scroll">
                            <table class="ang-table">
                                ...
                                <tbody id="table-body-dataEstate">
                                    <tr><td colspan="4" class="ang-loading">Memuat data...</td></tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="ang-table-scroll">
                            <table class="ang-table">
                                ...
                                <tbody id="table-body-RssProducers">
                                    <tr><td colspan="5" class="ang-loading">Memuat data...</td></tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="ang-table-scroll">
                            <table class="ang-table">
                                ...
                                <tbody id="table-body-TsrProducers">
                                    <tr><td colspan="6" class="ang-loading">Memuat data...</td></tr>
                                </tbody>
                            </table>
                        </div>
...
(function() {
    ...
    function renderTable(tabId, page = 1) {
        ...
        fetch(`${cfg.url}?page=${page}`)
            ...
            .catch(err => {
                tbody.innerHTML = `<tr><td colspan="${cfg.colCount}" class="ang-empty">Gagal memuat data. Silakan refresh halaman.</td></tr>`;
    ...
    function renderRows(tabId, data, page) {
        ...
        if (!data.data || data.data.length === 0) {
            tbody.innerHTML = `<tr><td colspan="${cfg.colCount}" class="ang-empty">Belum ada data anggota di kategori ini.</td></tr>`;
            return;
        }
        ...
        const filtered = search
            ? data.data.filter(item => {
                const haystack = [item.prov, item.company, item.email, item.rss_product, item.tsr_product, item.product_code]
                    .filter(Boolean)
                    .join(' ')
                    .toLowerCase();
        ...
        if (filtered.length === 0) {
            tbody.innerHTML = `<tr><td colspan="${cfg.colCount}" class="ang-empty">Tidak ada hasil untuk pencarian "${escapeHtml(search)}".</td></tr>`;
            return;
        }
    ...
    function renderPagination(tabId, data) {
        ...
        pages.forEach(p => {
            if (p === '...') {
                ...
                span.style.cssText = 'display:inline-flex;align-items:center;padding:0 0.5rem;color:var(--c-fade);font-weight:600;';
                span.textContent = '…';
