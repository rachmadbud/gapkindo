...
<style>
    ...
    .gpk-section--dark .gpk-section__title { color: var(--c-cream); }
    ...
    @media (min-width: 880px) {
        .gpk-section__head { grid-template-columns: 1fr 1fr; gap: 3rem; }
    }
    ...
    @media (max-width: 600px) {
        .gpk-stats { grid-template-columns: 1fr; }
        .gpk-stats .gpk-stat { border-right: none !important; border-bottom: 1px solid var(--c-line); }
        .gpk-stats .gpk-stat:last-child { border-bottom: none; }
    }
    ...
    @media (max-width: 768px) {
        .gpk-intro__visual { aspect-ratio: 16 / 10; }
    }
    ...
    .gpk-quick__head .gpk-eyebrow::before { width: 44px; }
    .gpk-quick__title {
        font-family: var(--f-display);
        font-weight: 500;
    ...
    @media (min-width: 600px) {
        .gpk-quick__grid { grid-template-columns: repeat(2, 1fr); }
    }
    @media (min-width: 980px) {
        .gpk-quick__grid { grid-template-columns: repeat(4, 1fr); }
    }
    ...
    .gpk-quick-card--teal    { background: #0F766E; }   /* teal */
    .gpk-quick-card--purple  { background: #6B21A8; }   /* purple */
    .gpk-quick-card--emerald { background: #047857; }   /* emerald green */
    .gpk-quick-card--amber   { background: #B45309; }   /* amber/orange */
    ...
    /* Card content */
    .gpk-quick-card__top { position: relative; z-index: 1; }
    ...
    .gpk-team__role--gold { color: var(--c-gold); }

    /* Dark section variant */
    .gpk-section--dark .gpk-team__name { color: var(--c-cream); }
    .gpk-section--dark .gpk-team__role { color: rgba(255, 251, 242, 0.55); }
    .gpk-section--dark .gpk-team__role--gold { color: var(--c-gold-soft); }
    .gpk-section--dark .gpk-team__photo { background: rgba(255, 255, 255, 0.05); }

    /* Mobile: 5-person rows wrap, cabang juga wrap proporsional */
    @media (max-width: 720px) {
        .gpk-team--cabang { justify-content: center; gap: 1.6rem 1.4rem; }
        .gpk-team--cabang .gpk-team__member { flex: 0 0 auto; }
    }
    ...
    .gpk-premium .gpk-cta__btn {
        ...
        box-shadow:
            ...
            inset 0 -1px 0 rgba(0, 0, 0, 0.15),           /* subtle bottom inset */
            0 2px 4px rgba(90, 64, 240, 0.25),            /* tight close */
            0 6px 14px rgba(90, 64, 240, 0.35),           /* mid float */
            0 14px 28px rgba(90, 64, 240, 0.25),          /* far drift */
            0 22px 44px rgba(90, 64, 240, 0.15);          /* ambient */
        transition:
            transform 0.35s cubic-bezier(0.34, 1.4, 0.6, 1),
            box-shadow 0.35s cubic-bezier(0.34, 1.4, 0.6, 1),
                    ...
                    <a href="{{ route('detail.news', app(\App\Helpers\Helper::class)->enkrip($news->id)) }}"
                       ...
                       title="{{ $news->title }}">
                        ...
                        <span class="gpk-news-card__cta">
                            Baca Selengkapnya
                            <svg class="gpk-news-card__cta-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                <path d="M5 12h14"/>
            ...
            <div class="gpk-team gpk-reveal">
                ...
                <a href="{{ route('soon') }}" class="gpk-team__member gpk-team__member--featured">
                    <div class="gpk-team__photo">
                        <img src="{{ asset('guest/assets/img/demo/MARTINUS-S-SINARYA.png') }}" alt="Martinus S. Sinarya" draggable="false" oncontextmenu="return false">
                    </div>
                ...
                @foreach ($pengawasAnggota as $p)
                    <a href="{{ route('soon') }}" class="gpk-team__member">
                        <div class="gpk-team__photo">
                            <img src="{{ asset('guest/assets/img/demo/' . $p['img']) }}" alt="{{ $p['name'] }}" draggable="false" oncontextmenu="return false">
                        </div>
    ...
    <section class="gpk-section gpk-section--soft">
        <div class="gpk-container">
            ...
            <div class="gpk-team gpk-reveal" style="margin-bottom: 3rem;">
                ...
                <a href="{{ route('soon') }}" class="gpk-team__member gpk-team__member--featured">
                    <div class="gpk-team__photo">
                        <img src="{{ asset('guest/assets/img/demo/alex-img.png') }}" alt="Alex Kurniawan Edy" draggable="false" oncontextmenu="return false">
                    </div>
                ...
                @php
                    $pengurus = [
                        ['name' => 'Timmie Melvin',           'role' => 'Sekretaris / Keuangan',   'img' => 'timmie-img.png'],
                        ['name' => 'Vargo Gunawan',           'role' => 'Organisasi / Bendahara',  'img' => 'vargo-img.png'],
            ...
            {{-- Sub-title untuk DPW --}}
            <div class="gpk-reveal" style="margin-bottom: 1.5rem; padding-top: 2rem; border-top: 1px solid var(--c-line); text-align: center;">
                <span class="gpk-eyebrow" style="justify-content: center;">DPW Daerah</span>
                <h3 style="font-family: var(--f-display); font-size: 1.6rem; font-weight: 500; letter-spacing: -0.02em; margin-top: 0.6rem; margin-bottom: 0;">Ketua <em style="font-style: italic; color: var(--c-gold); font-weight: 400;">Cabang</em> Provinsi</h3>
            </div>
            ...
            <div class="gpk-team gpk-team--cabang gpk-reveal">
                @php
                    $dpw = [
                        ...
                        ['name' => 'Andreas Winata',       'region' => 'Kalsel-Teng-Tim',  'img' => 'cabang/ketua/userDefault.png'],
                ...
                @foreach ($dpw as $d)
                    <a href="{{ route('soon') }}" class="gpk-team__member">
                        <div class="gpk-team__photo">
                            <img src="{{ asset('guest/assets/img/' . $d['img']) }}" alt="{{ $d['name'] }}" draggable="false" oncontextmenu="return false">
                        </div>
    ...
    <section class="gpk-quick">
        <div class="gpk-container">
            ...
            <div class="gpk-quick__grid">
                ...
                <a href="#" class="gpk-quick-card gpk-quick-card--teal gpk-reveal" data-delay="1" id="quickOpenTautan">
                    <div class="gpk-quick-card__top">
                        ...
                        <p class="gpk-quick-card__sub">Akses cepat ke menu Tautan: kementerian & mitra internasional</p>
                    </div>
                    <svg class="gpk-quick-card__icon-bg" viewBox="0 0 24 24" fill="currentColor"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>
                    <span class="gpk-quick-card__cta">Buka Menu Tautan <span class="gpk-quick-card__cta-arrow">→</span></span>
                </a>

                {{-- Card 2: ARSIP BERITA (purple) → Media › Berita --}}
                <a href="{{ route('berita') }}" class="gpk-quick-card gpk-quick-card--purple gpk-reveal" data-delay="2">
                    <div class="gpk-quick-card__top">
                    ...
                    <svg class="gpk-quick-card__icon-bg" viewBox="0 0 24 24" fill="currentColor"><path d="M20 3H3c-1.1 0-2 .9-2 2v11c0 1.1.9 2 2 2h3v3l3-3h11c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM5 7h13v2H5V7zm8 7H5v-2h8v2zm5-3H5V9h13v2z"/></svg>
                    <span class="gpk-quick-card__cta">Baca Berita <span class="gpk-quick-card__cta-arrow">→</span></span>
                </a>

                {{-- Card 3: GALERI (emerald) → Media › Galeri --}}
                <a href="{{ route('galeri') }}" class="gpk-quick-card gpk-quick-card--emerald gpk-reveal" data-delay="3">
                    <div class="gpk-quick-card__top">
                    ...
                    <svg class="gpk-quick-card__icon-bg" viewBox="0 0 24 24" fill="currentColor"><path d="M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z"/></svg>
                    <span class="gpk-quick-card__cta">Lihat Galeri <span class="gpk-quick-card__cta-arrow">→</span></span>
                </a>

                {{-- Card 4: CABANG GAPKINDO (amber) → About Us › Cabang --}}
                <a href="{{ route('cabang') }}" class="gpk-quick-card gpk-quick-card--amber gpk-reveal" data-delay="4">
                    <div class="gpk-quick-card__top">
                    ...
                    <svg class="gpk-quick-card__icon-bg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                    <span class="gpk-quick-card__cta">Lihat Cabang <span class="gpk-quick-card__cta-arrow">→</span></span>
                </a>
        ...
        <div class="gpk-container">
            <div class="gpk-cta__inner gpk-reveal">
                ...
                <a href="{{ route('kontak') }}" class="gpk-cta__btn">
                    ...
                    <svg class="gpk-cta__btn-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                        <path d="M5 12h14"/>
                        <path d="M13 6l6 6-6 6"/>
                    </svg>
                </a>
