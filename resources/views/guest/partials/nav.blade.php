            ...
            <ul class="main-nav nav navbar-nav navbar-right">
                <li class="dropdown ymm-sw " data-wow-delay="0.1s">
                    ...
                    <ul class="dropdown-menu navbar-nav">
                        <li>
                            <a href="{{ route('soon') }}">Home Style 2</a>
                        </li>
                        <li>
                            <a href="{{ route('soon') }}">Home Style 3</a>
                        </li>
                            ...
                            <div class="yamm-content">
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="{{ route('soon') }}">Home Style 1</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('soon') }}">Home Style 2</a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="{{ route('soon') }}">Home Style 4</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('soon') }}">Home Style 5</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-3">
